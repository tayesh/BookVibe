...
import { getReadBooks } from './LocalStorage';
...
const PagesToRead = () => {
    ...
    useEffect(() => {
        ...
        filteredBooks.forEach(book => {
            // Check if the length of bookname is greater than 8
            if (book.bookName.length > 8) {
              // Shorten the bookname to 8 characters
              book.bookName = book.bookName.substring(0, 10)+ '...';
            }
          });
